...
public class RabbitConfig {
    ...
    public ConnectionFactory connectionFactory() {
        ...
        connectionFactory.setVirtualHost(vtHost);
        connectionFactory.setPublisherConfirms(pubConf);
        connectionFactory.setPublisherReturns(pubReturns);
