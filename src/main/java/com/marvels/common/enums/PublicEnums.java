...
public class PublicEnums {
	...
	public enum JfInterfaceCodeEnum {
		...
		JF100183("100183", "风控设备指纹实时反欺诈-前置接口", "/fincloud/common.intf"),
		JF100184("100184", "额度查询-前置接口", "/fincloud/common.intf"),
		JF100185("100185", "查询用户已绑定的银行卡列表", "/fincloud/common.intf"),
		JF100186("100186", "根据身份证号码查询客户基本信息", "/fincloud/common.intf"),
		JF100187("100187", "客户注册接口 (实名 )", "/fincloud/common.intf"),
        ...
        JF100188("100188", "查询借据还款记录`", "/fincloud/common.intf"),
        JF100251("100251", "查询用户下所有借据接口", "/fincloud/common.intf"),
